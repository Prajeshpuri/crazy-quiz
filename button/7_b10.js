    function b10(){
        ...
        tf6  = document.getElementById("tf6").value;
             ...
             if(tf1 == "")
            document.getElementById("tf1").value=("P");
        else if(tf2 == "")
            document.getElementById("tf2").value=("P");
        else if(tf3 == "")
            document.getElementById("tf3").value=("P");
        else if(tf4 == "")
            document.getElementById("tf4").value=("P");
        else if(tf5 == "")
            document.getElementById("tf5").value=("P");
        else if(tf6 == "")
            document.getElementById("tf6").value=("P");
