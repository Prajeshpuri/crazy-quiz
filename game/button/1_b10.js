	function b10(){
        ...
        tf10 = document.getElementById("tf10").value;
             ...
             if(tf1 == "")
        	document.getElementById("tf1").value=("Q");
        else if(tf2 == "")
        	document.getElementById("tf2").value=("Q");
        else if(tf3 == "")
        	document.getElementById("tf3").value=("Q");
        else if(tf4 == "")
        	document.getElementById("tf4").value=("Q");
        else if(tf5 == "")
        	document.getElementById("tf5").value=("Q");
        else if(tf6 == "")
        	document.getElementById("tf6").value=("Q");
        else if(tf7 == "")
        	document.getElementById("tf7").value=("Q");
        else if(tf8 == "")
        	document.getElementById("tf8").value=("Q");
        else if(tf9 == "")
        	document.getElementById("tf9").value=("Q");
        else if(tf10 == "")
        	document.getElementById("tf10").value=("Q");
